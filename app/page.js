  ...
  return <><EntrySplash /><Nav /><AnnouncementBar /><main className="container">
    ...
    <section className="quran-trust-section moroccan-frame" aria-labelledby="quran-trust-title">
      <div className="quran-trust-heading">
        ...
        <p>بشفافية: نص القرآن المعروض داخل الموقع مصدره مشروع تنزيل Tanzil بالنص العثماني، وليس من إسلام ويب أو إسلام أون لاين. نضع رابط إسلام أون لاين كمرجع قراءة خارجي فقط، ونضع رابط تنزيل ليتمكن الزائر من مراجعة مصدر النص.</p>
      </div>
      <div className="quran-trust-grid">
        ...
        <div>
          <strong>فحص آلي قبل النشر</strong>
          <p>يتم التحقق آليًا من ٦٢٣٦ آية، و١١٤ سورة، و٣٠ جزءًا، مع ترتيب الآيات وأرقامها ومطابقة النص مع تنزيل.</p>
        </div>
        <div>
          <strong>حدود التحقق</strong>
          <p>التحقق البرمجي يقلل احتمال الخطأ ولا يغني عن المراجعة البشرية، لذلك نعرض المصدر بوضوح ونراجع أي ملاحظة فورًا.</p>
        </div>
      </div>
    </section>
