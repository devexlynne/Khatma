...
const LOCATIONS = [
  ...
  ["باريس، فرنسا", "Paris", "France", 48.8566, 2.3522],
];
  ...
  const useMyLocation=()=>{
    ...
    navigator.geolocation.getCurrentPosition(
      ({coords})=>{
        ...
        setLocation({city:"Current location",country:inFrance?"France":"",label:inFrance?"موقعي الحالي — فرنسا":"موقعي الحالي",latitude:coords.latitude,longitude:coords.longitude});
      },
