...
export default function Nav() {
  ...
  return <nav className="nav"><div className="container nav-inner">
    <div className="brand-wrap"><Link href="/" className="brand"><span className="logo">ن</span><span>نور الوالدين</span><span className="brand-star" aria-hidden="true">✦</span></Link><AnnouncementSignal />{user ? <NotificationCenter /> : null}</div>
